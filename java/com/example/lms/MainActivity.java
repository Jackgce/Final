...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.cse) {
            ...
            Intent i = new Intent(getApplicationContext(), ecebooks.class);
            startActivity(i);
            finish();

        } else if (id == R.id.civil) {
            Intent i = new Intent(getApplicationContext(), civilbooks.class);
            startActivity(i);
            finish();

        } else if (id == R.id.mech) {

            Intent i = new Intent(getApplicationContext(), mechbooks.class);
            startActivity(i);
            finish();
